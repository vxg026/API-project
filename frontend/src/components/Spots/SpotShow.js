...
// console.log("spoooooot in shpotshow", spot)
 ...
 <div className="spotshow-info">
               ...
               <i className="fas fa-star"/>{spot.numReviews?"·":""}{spot.avgStarRating?.toFixed(1)} {spot.numReviews? spot.numReviews: ""} #{(spot.numReviews ? spot.numReviews && spot.numReviews<=1 ? "review": "reviews": "New!")} </h4>
            </div>
                </div>
            ...
            <div className="spotshow-container-four">
                ...
                <h4><i className="fas fa-star"/>{spot.numReviews?"·":""}{spot.avgStarRating?.toFixed(1)} {spot.numReviews? spot.numReviews: ""} #{(spot.numReviews ? spot.numReviews && spot.numReviews<=1 ? "review": "reviews": "New!")} </h4>
